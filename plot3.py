...
indices = ["0.1","0.01","\"1/i\"", "0"]
col = {}
notplotlr = []#['0.4', '0.7']
files = {"data/data_du_50_lr_0.8_di_1.0_sz_5_egreedy.csv":0, "data/data_du_50_lr_0.8_di_1.0_sz_5_0.01egreedy.csv":1, "data/data_du_50_lr_0.8_di_1.0_sz_5_nanegreedy.csv":2, "data/data_du_50_lr_0.8_di_1.0_sz_5.csv":3}
...
plt.ylabel('Scores')
plt.savefig("images2/plot3_TA"+str(TREND_ACCURACY)+"without"+str(notplotlr)+".png", dpi=DPI)
