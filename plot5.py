...
indices = ["4 step","3 steps","2 steps"]
col = {}
notplotlr = []#['0.4', '0.7']
files = {"data/data_du_50_lr_0.8_di_1.0_sz_5_4steps_sarsa.csv":2, "data/data_du_50_lr_0.8_di_1.0_sz_5_3steps_sarsa.csv":1, "data/data_du_50_lr_0.8_di_1.0_sz_5_2steps_sarsa.csv":0}
...
plt.ylabel('Scores')
plt.savefig("images2/plot5_TA"+str(TREND_ACCURACY)+"without"+str(notplotlr)+".png", dpi=DPI)
